...
class MinhasSolicitacoes extends BaseController
{
    ...
    public function index()
    {
        ...
        // Quando implementar autenticação, adicione:
        // $builder->where('se.solicitante', user_id());
        ...
        $data = [
            ...
            'tituloPagina' => 'Minhas Solicitações de Edição'
        ];
    ...
    public function detalhes($id)
    {
        ...
        try {
            ...
            log_message('error', 'Erro em MinhasSolicitacoes::detalhes: ' . $e->getMessage());
            return $this->respond([
                'status' => 'error',
